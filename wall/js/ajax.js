...
var mtime;
var data=new Array();
data[0]=new Array('0','http://yanson-data.stor.sinaapp.com/196333960head.jpg','yanson2','墙来啦');


//data[1]=new Array('2','files/12.jpg','yanson2','#yanson#测试2');
//data[2]=new Array('3','files/1.jpg','yanson2','#yanson#测试399');
