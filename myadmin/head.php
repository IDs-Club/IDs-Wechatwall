...
<div id="body-wrapper">
  ...
  <div id="sidebar">
    <div id="sidebar-wrapper">
      ...
      <div id="profile-links"> 酷文博（http://coolwb.com）<br />
        <br />
        <a href="http://coolwb.com/5602.html" title="客服中心" target="_blank"><b>在线客服</b></a>&nbsp|&nbsp<a href="main.php" title="后台">后台首页</a>&nbsp|&nbsp<a href="logout.php" title="退出">退出</a></div>
      <ul id="main-nav">
        <!-- Accordion Menu -->
        <li> <a href="#" class="nav-top-item" id="up">
		 ...
		 <li> <a href="#" class="nav-top-item" id="up">
          ...
          高级 </a>
          <ul>
            <li><a href="toupiao.php"  id="shenhe">系统设置</a></li>
          </ul>
        </li>
